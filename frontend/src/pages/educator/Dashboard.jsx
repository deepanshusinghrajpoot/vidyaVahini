...
const Dashboard = () => {
 ...
 useEffect(()=>{
  ...
  return dashboardData ?  (
    <div className='min-h-screen flex flex-col items-center justify-between gap-8 md:p-8 md:pb-0 pt--8 pb-0'>
                   ...
                   <table className='table-fixed md:table-auto w-full overflow-hidden'>
                         <thead className='text-gray-900 border-b border-gray-500/20 text-sm text-left'>
                               <tr>
                                     ...
                                     <th className='px-4 py-3 font-semibold'>Course Titel</th>
                               </tr>
                         </thead>
